...
export default function ShaderSettingsInterface() {
  ...
  return (
    <>
      <div className="fixed top-0 right-0 z-50 overflow-auto max-h-dvh max-w-screen w-full h-full">
        <div className="w-full flex flex-col justify-center items-center md:items-end pt-4 md:pr-4">
          <div id="shader-settings-interface" className="w-full h-full min-w-[300px] max-w-[360px] space-y-4 border rounded-md p-4 bg-background">
