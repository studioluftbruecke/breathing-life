...
export default function ShaderSettingsInterface() {
  ...
  return (
    <>
      <div className={`fixed top-2 right-2 w-8 h-8 z-50 ${isToggled ? 'hidden' : ''}`}>
        <animated.div
          style={{
      ...
      <div className={`fixed top-2 right-0 w-full max-w-screen md:w-fit md:right-2 flex flex-col justify-center items-center md:items-end z-50 ${isToggled ? '' : 'hidden'}`}>
        <animated.div
